...
const labels: Record<keyof ScoringRules, string> = {
  correct_qualified_team: "Correct qualified team to Round of 32",
...
const currentPhaseRuleKeys: (keyof ScoringRules)[] = [
  "correct_qualified_team",
  "correct_group_winner",
  "correct_group_runner_up",
  "correct_third_place_qualifier"
];
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Future knockout scoring locked
          </CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-sm leading-6 text-muted-foreground">
            Finalist, champion, and later knockout-stage scoring will be exposed
            when the knockout prediction phase opens.
          </p>
        </CardContent>
      </Card>
